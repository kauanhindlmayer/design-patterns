import CalculateCheckout from "~/gof/structural/adapter/checkout/CalculateCheckout";
import { CatalogGatewayHttp } from "~/gof/structural/adapter/checkout/CatalogGateway";
import { FetchAdapter } from "~/gof/structural/adapter/checkout/HttpClient";
